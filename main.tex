...
\student{\stud}
{3174827}						% Matrikelnummer
{Informatik}					% Studiengang
\MyTitelseite{}                 % Ohne Logo eines anderen unternehmens
%\MyTitelseite{images/logo.svg}	% Optionales Logo des extern betreuenden Unternehmens
{1}								% Style der Titelseite (1 oder 2)
{Bachelorarbeit}				% Typ der Abschlussarbeit (\in {Bachelorarbeit, Masterarbeit})
{Vergleich verschiedener Ansätze der Multi-Plattform-Applikationsentwicklung anhand einer Beispiel-Anwendung}				% Thema der Arbeit						
{Prof.\ Dr.-Ing.\ Kai Selgrad}		% Betreuer
{Prof.\ Dr. rer.\ nat. Wolfgang Mauerer}	% Zweitgutachter
{11.08.\the\year}	% Abgabedatum
%{Daniel Dengler, Number42 GmbH} % externer Betreuer
...
\input{inhalt/01_motivation}
\chapter{Verwandte Arbeiten}
\input{inhalt/02_related}
\chapter{Grundlagen}
\input{inhalt/03_Grundlagen/03_00_grundlagen}
\chapter{Entwicklung}
\label{cha:4_Entwicklung}
\input{inhalt/04_Entwicklung/04_00_einleitung}
\chapter{Auswertung}
\input{inhalt/05_auswertung}
\chapter{Fazit und Ausblick}
\input{inhalt/06_fazit}
