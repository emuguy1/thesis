...
\ifthenelse{\equal{#1}{}}{
	...
	\includegraphics[scale=0.2]{lib/oth-logo.png}\hfill\includesvg{images/logo.svg}
}
\begin{center}
\ifthenelse{\equal{#2}{2}}{ % then
	...
	\begin{tabular}{rl}%{6cm}p{7.5cm}}
		...
		\rule{0mm}{1ex}\textbf{Zweitgutachter:} & #6 \\
		%\rule{0mm}{1ex}\textbf{Externer Betreuer:} & #8 
		\\[2em]
...
\newcommand{\TODO}[1]{\\ \colorbox{yellow}{\parbox{\textwidth}{TODO: #1}\\}}
