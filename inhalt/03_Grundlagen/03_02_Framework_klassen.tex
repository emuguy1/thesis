...
Auch bei diesem Ansatz ist die Funktionalität und die Zahl der unterstützten Plattformen von dem genutzten Cross-Compiler abhängig. Einige dieser Frameworks nutzen eine spezialisierte Programmiersprache, sodass eine Wiederverwendung des Codes, für einen anderen Ansatz, erschwert wird. So wird etwa bei Flutter\footnote{https://flutter.dev/} die Sprache Dart\footnote{https://dart.dev/} genutzt.
